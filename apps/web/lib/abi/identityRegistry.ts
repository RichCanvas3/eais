...
export const identityRegistryAbi = [
  ...
  { type: "function", name: "registryChainId", stateMutability: "view", inputs: [], outputs: [{ type: "uint64" }] },
  { type: "function", name: "identityRegistryAddress", stateMutability: "view", inputs: [], outputs: [{ type: "address" }] },
  { type: "function", name: "exists", stateMutability: "view", inputs: [{ name: "agentId", type: "uint256" }], outputs: [{ type: "bool" }] },
  ...
  { type: "function", name: "setTokenURI", stateMutability: "nonpayable", inputs: [{ name: "agentId", type: "uint256" }, { name: "uri", type: "string" }], outputs: [] },
